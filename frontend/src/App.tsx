...
function App() {
    const weddingDate = useMemo(() => new Date(2026, 6, 10, 11, 45), []);
    const colors = [
        "#dce3d6",
        "#ebc7cc",
        "#526f5b",
    ...
    return (
        <div className="w-svw flex justify-center">
            <div className="max-w-88 w-10/12">
                ...
                <div className="flex flex-col items-center bg-page shadow-[0_0_15px_2px] shadow-primary/20 text-primary">
                    ...
                    <div className="mt-4 w-full flex flex-col items-center gap-4">
                        ...
                        <p className="w-4/5 text-center font-light text-sm">
                            ...
                            наполненный любовью, теплом и радостными моментами.
                            С нетерпением ждём вас, чтобы вместе создать
                    ...
                    <div className="mt-4 flex flex-row w-4/5 font-marggraff text-3xl text-center justify-between">
                        ...
                        <div>
                            <p>{Math.floor(timeLeft / (1000 * 60)) % 60}</p>
                    ...
                    <div className="mt-8 flex flex-col items-center w-full">
                        ...
                        <div className="py-2 w-3/4 bg-[#979870] text-page text-center">
                            <div>
                                <p className="font-marggraff text-xl">11:30</p>
                                <p>Сбор гостей</p>
                            </div>
                            <div className="mt-2">
                                <p className="font-marggraff text-xl">11:45</p>
                                <p>Роспись</p>
                            </div>
                            <div className="mt-2">
                                <p className="font-marggraff text-xl">18:30</p>
                                <p>Начало празднования</p>
                            </div>
                            <div className="mt-2">
                                <p className="font-marggraff text-xl">21:00</p>
                                <p>Торт</p>
                            </div>
                            <div className="mt-2">
                                <p className="font-marggraff text-xl">22:00</p>
                                <p>Финал торжества</p>
                            </div>
                        </div>
                    </div>
                    <div className="mt-8 text-primary text-center w-4/5">
                        <h3 className="font-marggraff text-3xl">Дресскод</h3>
                        <p className="mt-2 font-light text-sm">
                            Нам будет приятно, если ваши образы поддержат
                            атмосферу нашего дня.
                        </p>
                    ...
                    <div className="mt-8 text-primary text-center w-full">
                        ...
                        <div className="mt-4 relative overflow-hidden h-40 text-page">
                            ...
                            <p className="absolute top-2 left-4 right-4 text-center">
                                Сбор гостей состоится возле Медеуского отдела
                                РАГС
                                <br />
                    ...
                    <div className="mt-4 text-primary text-center w-full">
                        <h3 className="font-marggraff text-3xl">
                            Место празднования
                        </h3>
                        <div className="mt-4 relative overflow-hidden h-40 text-page">
                ...
                <div className="flex flex-col justify-center items-center h-20 gap-2 text-primary">
                    ...
                    >
                        <img
                            className="svg-primary w-5 pect-square"
                            src={whatsappIcon}
                            alt="whatsapp"
                        />
                        <p>+7 747 690 3698</p>
